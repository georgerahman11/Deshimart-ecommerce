...
function woocustomizer_library_get_all_fonts() {
	$heading1       = array( 1 => array( 'label' => sprintf( '--- %s ---', __( 'Standard Fonts', 'woocustomizer' ) ) ) );
	$standard_fonts = woocustomizer_library_get_standard_fonts();
	$heading2       = array( 2 => array( 'label' => sprintf( '--- %s ---', __( 'Google Fonts', 'woocustomizer' ) ) ) );
...
function woocustomizer_library_get_google_font_subsets() {
	return array(
		'all'          => __( 'All', 'woocustomizer' ),
		'cyrillic'     => __( 'Cyrillic', 'woocustomizer' ),
		'cyrillic-ext' => __( 'Cyrillic Extended', 'woocustomizer' ),
		'devanagari'   => __( 'Devanagari', 'woocustomizer' ),
		'greek'        => __( 'Greek', 'woocustomizer' ),
		'greek-ext'    => __( 'Greek Extended', 'woocustomizer' ),
		'khmer'        => __( 'Khmer', 'woocustomizer' ),
		'latin'        => __( 'Latin', 'woocustomizer' ),
		'latin-ext'    => __( 'Latin Extended', 'woocustomizer' ),
		'vietnamese'   => __( 'Vietnamese', 'woocustomizer' ),
	);
}
endif;
...
function woocustomizer_library_get_standard_fonts() {
	return array(
		'serif' => array(
			'label' => _x( 'Serif', 'font style', 'woocustomizer' ),
			'stack' => 'Georgia,Times,"Times New Roman",serif'
		),
		'sans-serif' => array(
			'label' => _x( 'Sans Serif', 'font style', 'woocustomizer' ),
			'stack' => '"Helvetica Neue",Helvetica,Arial,sans-serif'
		),
		'monospace' => array(
			'label' => _x( 'Monospaced', 'font style', 'woocustomizer' ),
