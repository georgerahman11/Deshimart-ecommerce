    ...
    public function wcz_quicknote_notice()
    {
        ...
        if ( current_user_can( 'manage_options' ) && !get_user_meta( $wcz_user_id, 'wcz_quicknote_notice_dismiss_1' ) && 'admin.php?page=wcz_settings&' == $wczpage ) {
            ...
            ?>
				...
				<p>
                    <?php 
            printf( esc_html__( 'If you\'re wanting to enhance your store with all the StoreCustomizer Pro features, now is your chance to get 20&#37; off using the coupon "%1$s".', 'woocustomizer' ), wp_kses( '<big><b>20SALE21</b></big>', array(
                'big' => array(),
                'b'   => array(),
            ) ) );
            ?><br />
					<small><?php 
            esc_html_e( 'This discount applies to all licence types, first purchases and renewals of StoreCustomizer Pro.', 'woocustomizer' );
            ?></small>
                </p>
				<a href="<?php 
